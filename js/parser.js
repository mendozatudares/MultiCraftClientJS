...
class GameCommand {
    constructor(doc) {
        ...
        this.args = {};
        this.argMethods = {
            "build": this.getBuildArgs,
            "place": this.getPlaceArgs,
            "move": this.getMoveArgs,
            "track": this.getTrackArgs,
            "turn": this.getLookArgs,
            "tilt": this.getLookArgs,
            "store": this.getStoreArgs,
            "clone": this.getStoreArgs,
            "give": this.getGiveArgs,
        };
    }
    ...
    getBuildArgs() {
        ...
        this.commandToken.forEach(element => {
            if (!buildShapeDetected && element in buildShapes) {
...
function processInstruction(instruction) {
    ...
    gameCommand.commandToken = nlp(instruction.toLowerCase());
    gameCommand.commandText = gameCommand.commandToken.text('reduced');
